...
class RateTouristBottomsheet extends StatefulWidget {
  final TouristListData touristData;

  RateTouristBottomsheet({required this.touristData});

  @override
  _RateTouristBottomsheetState createState() => _RateTouristBottomsheetState();
}

class _RateTouristBottomsheetState extends State<RateTouristBottomsheet> {
  double rating = 0.0;
              ...
              onPressed: () {
                ...
                if (rating > 0 && commentController.text.isNotEmpty) {
                  ...
                  NotificationService().simpleNotificationShow(
                    ...
                    body: 'Thank you for rating and commenting on ${widget.touristData.titleTxt}!',
                  );
                } else {
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
                        ...
                        children: [
                          Text(
                            _truncateWithEllipsis(
                                widget.touristData.titleTxt, 10),
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        widget.touristData.rating.toString(),
                                ...
                                Text(
                                  "(${widget.touristData.reviews} reviews)",
          ...
          _buildRateTouristColumn(context),
        ],
      ),
    );
  }
  ...
  Widget _buildRateTouristColumn(BuildContext context) {
    return Align(
      alignment: Alignment.center,
  ...
  Future<void> fetchCommentsAndUpdateUI() async {
    try {
      ...
      await saveRatingDataToFirestore(newAverageRating, newTotalReviews);
      print("Sa bottom sheet ni bai");
      print(newAverageRating);
      print(newTotalReviews);
  ...
  Future<void> saveRatingDataToFirestore(double newAverageRating, int newTotalReviews) async {
    try {
      await _firestore
          .collection('HotelApp')
          .doc('TouristRatings')
