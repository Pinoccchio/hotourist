...
import '../booking_name_page/tourist_booking_name_page.dart';

class TouristSelectDateGuestScreen extends StatefulWidget {
  final int touristPrice;
  final TouristListData touristData;

  const TouristSelectDateGuestScreen({Key? key, required this.touristPrice, required this.touristData}) : super(key: key);

  @override
  _TouristSelectDateGuestScreenState createState() => _TouristSelectDateGuestScreenState();
}

class _TouristSelectDateGuestScreenState extends State<TouristSelectDateGuestScreen> {
  ...
  Widget build(BuildContext context) {
    int total = selectedQuantity * widget.touristPrice; // Calculate total
  ...
  Widget _buildAutoLayoutHorizontal(BuildContext context) {
    total = selectedQuantity * widget.touristPrice; // Calculate total
    ...
    return CustomElevatedButton(
      ...
      onPressed: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TouristBookingNamePage(
