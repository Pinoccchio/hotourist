...
class ConfirmPaymentScreen extends StatelessWidget {
    ...
    children: [
     ...
     Padding(
      ...
      child: Column(
       ...
       children: [
        Text(hotelData.titleTxt, style: theme.textTheme.titleLarge),
        SizedBox(height: 15.v),
        Text(hotelData.subTxt, style: theme.textTheme.bodyMedium),
        ...
        Row(
         children: [
          ...
          Padding(
           ...
           child: Text(
            "${hotelData.rating.toStringAsFixed(1)}", // Limit to 1 decimal place
     ...
     Padding(
      ...
      child: Column(
       ...
       children: [
        Text("${hotelData.perNight}", style: CustomTextStyles.headlineSmallPrimary),
        SizedBox(height: 2.v),
 ...
 Widget _buildPrice(BuildContext context) {
  ...
  double totalPerNight = (hotelData.perNight * nights).toDouble();
 ...
 void saveDataToFirestore(BuildContext context) async {
  ...
  DocumentReference bookingDocRef = await ongoingBookingsCollection.add({
   ...
   'location': hotelData.subTxt,
   'image': hotelData.imagePath,
   'fullName': fullName,
   'nickName': nickName,
  ...
  return CustomElevatedButton(
    ...
    */
    ...
    NotificationService().simpleNotificationShow(
     ...
     body: 'Thank you for booking ${hotelData.titleTxt}! Enjoy your stay!',
    );
