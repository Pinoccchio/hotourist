...
class ReviewTabContainerScreen extends StatefulWidget {
  final HotelListData hotelData;
  const ReviewTabContainerScreen({Key? key, required this.hotelData})
      : super(
    key: key,
  );
...
class ReviewTabContainerScreenState extends State<ReviewTabContainerScreen>
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ReviewPage(hotelData: widget.hotelData),
                    ],
                  ),
                ),
              ),
  ...
  _showModalBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) => RateHotelBottomsheet(hotelData: widget.hotelData),
    );
  }
