...
class FramenineteenItemWidgetState extends State<FramenineteenItemWidget> {
  ...
  //SA ONCANCEL, FIX THE OVERFLOW FOR LOCATION
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CustomImageView(
                imagePath: comment['userProfile'] ?? 'lib/assets/default_profile.png',
                height: 48.adaptSize,
                width: 48.adaptSize,
              ...
              CustomElevatedButton(
                height: 32.v,
                width: 60.h,
                text: (comment['userRate'] as double?)?.toStringAsFixed(1) ?? '0', // Limit to 1 decimal place
