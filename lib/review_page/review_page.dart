...
class ReviewPage extends StatefulWidget {
  ...
  const ReviewPage({Key? key, required this.hotelData}) : super(key: key);

  @override
  ReviewPageState createState() => ReviewPageState();
}

class ReviewPageState extends State<ReviewPage> with AutomaticKeepAliveClientMixin<ReviewPage> {
  User? currentUser;
  ...
  void _notifyNewComment() {
    NotificationService().simpleNotificationShow(
      title: 'New Comment',
      body: 'There is a new comment on ${widget.hotelData.titleTxt}!',
    );
  }
  ...
  Widget _buildReviewListComponent(BuildContext context) {
    return comments.isEmpty
      ...
      itemBuilder: (context, index) {
        ...
        return ReviewListComponentItemWidget(
