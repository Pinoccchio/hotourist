...
import '../../presentation/home_screen_page/hotel_class/touristSpot_list_model.dart';

class TouristReviewListComponentItemWidget extends StatelessWidget {
  ...
  const TouristReviewListComponentItemWidget({
    Key? key,
  ...
  void _deleteComment(BuildContext context) async {
    ...
    if (confirmDelete != null && confirmDelete) {
      await FirebaseFirestore.instance
          ...
          .collection(touristData.titleTxt) // Use touristData.titleTxt instead of hotelData.titleTxt
